...
<!--                        breadcrumb-->
                        <nav style=" margin-top: 15px;" aria-label="breadcrumb">
                            <ol style="width: 100%" class="breadcrumb">
                                ...
                                <div style="float: right;  margin-left: 77%;"><h4><?php echo 'страница'; ?></h4></div>
                            </ol>
                        </nav>
                    ...
                    <div  class=" col-xs-12 col-sm-2 col-md-2 col-md-offset-1 media " style="background-color: #E9ECEF;opacity: 0.7;margin-top: 25px;  height: 1000px " >
                        <div>
                            <ul class="list-unstyled">
                                <h3  class="mx-auto" style=" width: 200px; margin-top: 30px; "><a href="#">New</a></h3><br>
                                <li>
                                    <h3>Заголовок</h3>
                        ...
                        <ul  style="width: 100px;class=list-unstyled mx-auto">
                            <h3><a href="/category">Категории</a></h3>
                            <li class="media my-4 "> <a href="#"> <img style="width: 200px" class=" rounded-circle" src="../../files/image/git.png" alt=""><div  class="media-body"> Главная</div></a></li>
                            <li class="media my-4 "> <a href="#"><img style="width: 200px" class=" rounded-circle" src="../../files/image/web.jpg" alt=""><div  class="media-body"> Главная</div></a></li>
                            <li class="media my-4 "> <a href="#"><img style="width: 200px" class=" rounded-circle" src="../../files/image/php.png" alt=""><div  class="media-body"> Главная</div></a></li>
                            <li class="media my-4 "> <a href="#"> <img style="width: 200px" class=" rounded-circle" src="../../files/image/git.png" alt=""><div  class="media-body"> Главная</div> </a></li>
                        </ul>

                        <div class="fixed-bottom">
                        <footer  class="mx-auto" style="width: 600px">
